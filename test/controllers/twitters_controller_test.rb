...
class TwittersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create twitter" do
    assert_difference('Twitter.count') do
      post twitters_url, params: { twitter: { bencana_id: @twitter.bencana_id, post: @twitter.post, tanggal: @twitter.tanggal } }
    end
  ...
  test "should update twitter" do
    patch twitter_url(@twitter), params: { twitter: { bencana_id: @twitter.bencana_id, post: @twitter.post, tanggal: @twitter.tanggal } }
